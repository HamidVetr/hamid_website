...
<div class="row justify-content-end">
    <div class="col-auto  ml-2 text-right">
        {!! Form::open(['method'=>'POST', 'action'=>'AdminControllers\UserController@forceMultiDelete', 'id'=>'deleteForm']) !!}
                    ...
                    <td>
                        <div class="Topbar_dropdown dropdown table_dropDown">
                            ...
                            <div data-dropdown-in="fadeIn" data-dropdown-out="fadeOut" class="dropdown-menu hi-shadow-2" aria-labelledby="dropdownMenuButton">
                                {!! Form::open(['method'=>'POST','action'=>['AdminControllers\UserController@restore',$user->id]]) !!}
                                ...
                                {!! Form::open(['method'=>'DELETE','action'=>['AdminControllers\UserController@forceDelete',$user->id]]) !!}
