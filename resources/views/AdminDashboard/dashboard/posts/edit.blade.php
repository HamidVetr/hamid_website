...
@section('content')
    ...
    <div class="row hi-createPostBox">
        <div class="col-8">
            {!! Form::model($post , ['method'=>'PUT', 'action'=>['AdminControllers\PostController@update', $post->id], 'id'=>'createPostForm', 'files' => true]) !!}
                <div class="row">
        ...
        <div class="col-4 mt-1">
                ...
                @component('AdminDashboard.components.posts.CreatePostLeftSidebar')
                    ...
                    @slot('list')
                        <div id="postCategories">
                            @include('AdminDashboard.includes.posts.PostCategoriesEdit')
                        </div>
                    @endslot
                    @slot('search_form')
            ...
            <div class="row">
                @component('AdminDashboard.components.posts.CreatePostLeftSidebar')
                    ...
                    @slot('list')
                        <div id="postTags">
                            @include('AdminDashboard.includes.posts.PostTagsEdit')
                        </div>
                    @endslot
                    @slot('search_form')
