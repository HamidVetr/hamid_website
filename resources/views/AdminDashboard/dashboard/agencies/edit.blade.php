...
@section('content')
    ...
    {!! Form::model($agency,['method'=>'PATCH','action'=>['AdminControllers\AgencyController@update',$agency->id]]) !!}
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 pt-5">
                            <div class="hi-profileCard_PictureSelectorBox_selector hi-profileCard_PictureSelectorBox_selector_first mt-4">
                                {!! Form::select('users_id',$users, $agency->users()->whereRoleIs('superConsultant')->pluck('id')
                                , ['multiple'=>'multiple','class'=>'dropdown', 'data-settings'=>'{"wrapperClass":"metro"}']) !!}
                            </div>
                        </div>
                    </div>
                </div>
...
@section('javascript')
    ...
    <script>
        var latc = $('#latitude').val();
        var longc = $('#longitude').val();
        function initMap() {
            ...
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(latc,longc),
                map: map
            });
