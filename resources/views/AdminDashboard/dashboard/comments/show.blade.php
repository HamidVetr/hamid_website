...
@section('content')
    ...
    <br>
    <div class="row answerPmBox">
        {!! Form::open(['method'=>'POST','action'=>'AdminControllers\CommentController@answer']) !!}
        <div class="card answerMsgFormCard">
            <div class="card-header answerMsgFormCard_header py-2">
                ...
                <span class="pull-left">
                    ...
                    {!! Form::text('post_id',$comment->id,['class'=>'form-control inputCategory','id'=>'inputCategory','tabindex'=>'1','hidden']) !!}
                    {!! Form::text('parent_id',$comment->id,['class'=>'form-control inputCategory','id'=>'inputCategory','tabindex'=>'1','hidden']) !!}
                </span>
